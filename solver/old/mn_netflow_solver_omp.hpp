#ifndef _MN_NETFLOW_SOLVER_OMP_H_
#define _MN_NETFLOW_SOLVER_OMP_H_
...
private:
  ...
  typedef PRFlow<dtype, KernelLattice, 0, nf_parameters> pr_flow_solver;
...
public:
  ...
  void run() {
    ...
    vector<pr_flow_solver> pr_flow_vector;

    // Start out by splitting the work based on the 
